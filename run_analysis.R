...
# outputs it to tidyData.txt, which the activity, the subject, and the averages
...
# OUTPUT: 
# "tidyMeasurements.txt" to current working directory
...
run_analysis <- function(){
     ...
     # Exporting the tidy dataframe as txt
     write.table(tidyMeasurements,"tidyMeasurements.txt",sep=",",row.names=FALSE)
